...
#processes text files from supplier-data/description directory and returns data into JSON dictionary
import os
import requests
...
for file in os.listdir("./supplier-data/descriptions"):
    with open(path + file) as f:
        ...
        response = requests.post("http://34.29.100.94/fruits/", json=fruits)
        fruits.clear()
