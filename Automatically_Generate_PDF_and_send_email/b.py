...
#generates table of Summary and sends pdf in email of summary"
...
def main(argv):
    ...
    data = load_data("/home/student-03-4def9aefa67f/car_sales.json")
    ...
    msg = email_generate("automation@example.com", "student-03-4def9aefa67f@example.com",
